...
@Singleton
@Slf4j
public class DeleteDynamicTokensTask extends Task {

    private final AerospikeConfig aerospikeConfig;

    public DeleteDynamicTokensTask(AerospikeConfig aerospikeConfig) {
        super("delete-dynamic-tokens");
    ...
    public void execute(ImmutableMultimap<String, String> parameters, PrintWriter out) throws Exception {
        if(parameters.containsKey("app")) {
            log.info("Deleting dynamic tokens for app: " +parameters.get("app"));
            final String setName = parameters.get("app") + "_tokens";
            ...
            out.print("Dynamic tokens for app: [" +parameters.get("app") +"] is being deleted" );
        } else {
